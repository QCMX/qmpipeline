...
np.savez_compressed(
    fpath, Navg=Navg, Nactual=Nactual, Zraw=Zraw, freqs=freqs, amps=amps, ampsV=ampsV,
...
secax.set_ylabel('output power at octave / dBm', fontsize=8)
