...
mixercal = qmtools.QMMixerCalibration(qmm, config_pipeline)
...
try:
    for i in range(Ngate):
        ...
        prog = progs[2] = qmtools.QMResonatorSpec_P2(
            qmm, localconfig, Navg=300,
            resonatorIFs=fr_range,
            readout_amps=np.logspace(-60/20, -5/20, 7)*AMP0dBm)
